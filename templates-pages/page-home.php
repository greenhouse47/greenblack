...
<div class="container-homepage">
	...
	<div class="container">
		<div class="homepage-logo">
			...
			<div><a href="<?php echo home_url('/'); ?>" title="<?php bloginfo('name'); ?>"><img itemprop="logo" src="<?php echo get_template_directory_uri();?>/img/logo.svg" style="height:auto;width:109px;float:left;"></a></div>
			<?php } else { ?>
		...
		<div class="row">
			<div class="span-left">
				<div class="span-left-content">
					<div class="icon_title"><img itemprop="headline-news" src="<?php echo get_template_directory_uri();?>/img/siaran.svg" ></div>
					<!-- Start headline title -->
					<div class="title-headline">
						<h3><?php echo get_option('greenhouse_title_headline_text'); ?></h3>
					</div>
			...
			<div class="span-right">
				<div class="icon_title"><img itemprop="notice_icon" src="<?php echo get_template_directory_uri();?>/img/pengumuman.svg" ></div>
				<!-- Start headline title -->	
				<div class="title-right-headline">			
					<h3><?php echo get_option('greenhouse_title_rightheadline_text'); ?></h3>
				</div>
				<!-- End Off headline title -->
				<?php while (have_posts()) : the_post(); ?>
				<?php // reset the loop
...
<div class="container">
    <div class="row">
		<div class="span4">
			<div class="icon_title_two"><img itemprop="video_icon" src="<?php echo get_template_directory_uri();?>/img/video.svg" ></div>
			<h3><?php echo get_option('greenhouse_title_video_text'); ?></h3>
			<div class="span_video">
				<?php echo stripslashes( get_option('greenhouse_video') );?>
			</div>
		</div>
		<div class="span4">
			<div class="icon_title_two"><img itemprop="suarakita_icon" src="<?php echo get_template_directory_uri();?>/img/suarakita.svg" ></div>
			<h3><?php echo get_option('greenhouse_suarakita_text'); ?></h3>
			<?php while (have_posts()) : the_post(); ?>
				<?php // reset the loop
				endwhile;
				wp_reset_query(); ?>
		...
		<div class="span4">
			<div class="icon_title_two"><img itemprop="agenda_icon" src="<?php echo get_template_directory_uri();?>/img/agenda.svg" ></div>
			<h3><?php echo get_option('greenhouse_agenda_text'); ?></h3>
			<?php while (have_posts()) : the_post(); ?>
				<?php // reset the loop
				endwhile;
				wp_reset_query(); ?>
    ...
    <div class="row">
		<div class="span6">
			<div class="home-berkarya">
				<div class="icon_title_thre"><img itemprop="berkarya_icon" src="<?php echo get_template_directory_uri();?>/img/karya.svg" ></div>
				<h3><?php echo get_option('greenhouse_karya_text'); ?></h3>
				<?php while (have_posts()) : the_post(); ?>
					<?php // reset the loop
					endwhile;
					wp_reset_query(); ?>
		...
		<div class="span6">
			<div class="icon_title_two"><img itemprop="lokasi_icon" src="<?php echo get_template_directory_uri();?>/img/lokasi.svg" ></div>
			<h3><?php echo get_option('greenhouse_title_maps_text'); ?></h3>
			<div class="home-map">
