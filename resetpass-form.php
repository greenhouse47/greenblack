...
<div class="login" id="theme-my-login<?php $template->the_instance(); ?>">
	...
	<form name="resetpasswordform" id="resetpasswordform<?php $template->the_instance(); ?>" action="<?php $template->the_action_url( 'resetpass' ); ?>" method="post">
		<p>
			<label for="pass1<?php $template->the_instance(); ?>"><i class="fa fa-key"></i> <?php _e( 'New password' ); ?></label>
		...
		<p>
			<label for="pass2<?php $template->the_instance(); ?>"><i class="fa fa-key"></i> <?php _e( 'Confirm new password' ); ?></label>
		...
		<p class="submit">
			<button type="submit" name="wp-submit" class="btn" id="wp-submit<?php $template->the_instance(); ?>"><i class="fa fa-unlock"></i> Reset Password</button>
